...
> {
  ...
  public render(): React.ReactElement<ILeaveProps> {
    ...
    const LeaveType = this.state.leaveSettings.map((item) => (
      <p>{item.text}</p>
    ));
    ...
    const LeaveDays = this.state.leaveBalance
      .slice(0, this.state.leaveSettings.length + 1)
    ...
    return (
      <div className={styles.employee}>
        <div className={styles.container}>
          <div className={styles.heading}>Leave Balance</div>
          <div className={styles.grid}>
            <div className={styles.gridRow}>
              ...
              <div className={styles.smallCol}>{LeaveType}</div>
              <div className={styles.largeCol}>{LeaveDays}</div>
            </div>
          </div>
        </div>
      </div>
